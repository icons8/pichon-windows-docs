( function( $ ) {
	...
	if ( headings.length ) {
		...
		var ghButtonHtml = "<a href='https://github.com/icons8/pichon-windows-docs' id='sections-button' class='btn btn--dark btn--rounded btn--w-icon btn--github js-affix'><i class='icon icon--github' style='float: left; margin-left: 0px; margin-right: 16px'></i>Suggest Edits</a>";
